...
export default class Mahasiswa extends Component {
  ...
  getData = () => {
    fetch("http://localhost:3002/mahasiswa?_sort=angkatan&_order=asc", {
      method: "GET"
    })
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              <div className="row">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="width-100px" id="inputGroup-sizing-default">
                      Nim
                    </span>
                  </div>
                  <input
              ...
              <div className="row">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <label class="width-100px" for="inputGroupSelect01">
                      Status
                    </label>
                  </div>
                  <select
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() => this.deteleData(mhs.id)}
                          >
                            Hapus
                          </button>
                        </td>
